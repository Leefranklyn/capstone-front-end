...
import { 
  Text, Box, Flex, FormControl, FormLabel, Input, Button, Image, Link as ChakraLink 
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <Flex direction="column" alignItems="center" paddingX={{ base: 4, md: 10 }} gap={{ base: 6, md: 10 }}>
        ...
        <Flex direction={{ base: 'column', md: 'row' }} gap={{ base: 6, md: '5%' }}>
          <Box flex="1">
          ...
          <Box flex="1">
            <Flex direction="column" gap={6} alignItems="center">
              <FormControl>
                ...
                <Input placeholder='Input your email address' width="100%" height="64px" paddingLeft="30px" fontSize="18px" fontFamily="roboto-serif" border="1px solid black" opacity={0.5}/>
              </FormControl>
              <FormControl>
                <FormLabel fontSize="24px" lineHeight="32px" fontWeight={400} fontFamily="roboto-serif">Password</FormLabel>
                <Input placeholder='Password' height="64px" paddingLeft="30px" fontSize="18px" fontFamily="roboto-serif" border="1px solid black" opacity={0.5}/>
              </FormControl>
              <Button as={ReactRouterLink} to="/login" width="100%" height="64px" marginTop={10} bg="customGreen.500" border="1px solid #09544d" _hover={{ bg: "customGreen.500" }}>
                <Text color="white" fontWeight={400} fontFamily="roboto-serif">Log In</Text>
              </Button>
